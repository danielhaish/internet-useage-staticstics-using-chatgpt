...
chat_query = "please classify the folowing context if the context is not good for kinds uner 12 then the first world of your answer should be unsafe with no commad other wise it should be one of the folowing words" + parmas 
